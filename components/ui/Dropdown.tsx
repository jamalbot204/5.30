  ...
  return (
    <>
      ...
      {isOpen && createPortal(
        <div 
          ref={menuRef} 
          className={`fixed z-[9999] bg-white dark:bg-zinc-900 rounded-xl shadow-xl p-1 flex flex-col gap-0.5 border border-gray-200 dark:border-white/10 animate-fade-in ${className}`} 
          style={{ 
            ...coords, 
