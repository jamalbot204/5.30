...
const TtsSettingsModal: React.FC<TtsSettingsModalProps> = memo(({ isOpen: propIsOpen, initialSettings, onApply, onClose }) => {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/80 z-50 flex justify-center items-center p-4" onClick={handleClose}>
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-0 rounded-lg shadow-2xl w-full sm:max-w-md max-h-[90vh] flex flex-col text-gray-200 relative overflow-hidden" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="p-5 flex justify-between items-center bg-[rgba(13,15,24,0.3)] border-b border-white/10">
            ...
            <Button
              ...
              className="p-1.5 rounded-full h-auto"
              aria-label={t.close}
            ...
            <fieldset disabled={areButtonsDisabled} className="space-y-4">
              ...
              <div className="relative p-4 rounded-r-xl rounded-l-md border border-white/10 border-l-4 border-l-purple-500 bg-gradient-to-r from-purple-500/5 to-transparent">
                ...
                <div className="pl-1">
                    ...
                    <Button type="button" onClick={handleOpenInstructionModal} variant="ghost" className="w-full p-2 bg-white dark:bg-zinc-800/50 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 text-left flex justify-between items-center transition-shadow hover:shadow-[0_0_12px_2px_rgba(168,85,247,0.4)] border-purple-500/20 group h-auto">
          ...
          <div className="p-4 border-t border-white/10 bg-[rgba(13,15,24,0.5)] flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            <Button variant="link" onClick={handleResetDefaults} disabled={areButtonsDisabled} className="text-emerald-400 hover:text-white">{t.resetDefaults}</Button>
