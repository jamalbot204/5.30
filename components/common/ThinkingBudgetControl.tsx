...
const ThinkingBudgetControl: React.FC<ThinkingBudgetControlProps> = memo(({
  ...
  return (
    <div>
      ...
      <div className={`flex items-center space-x-3 bg-black/20 p-2 rounded-lg border border-white/5 transition duration-200 ${isPresetValue ? 'opacity-60 grayscale' : 'opacity-100'}`}>
        <input
          type="range"
          min={min}
          max={max}
