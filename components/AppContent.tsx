...
const AppContent: React.FC = memo(() => {
  ...
  return (
    <div className="flex h-[100dvh] antialiased bg-gradient-to-br from-[#F4F9F9] to-[#E8F4F8] dark:from-[#0e0e11] dark:to-[#0e0e11] text-gray-900 dark:text-zinc-100 overflow-hidden w-screen">
        ...
        <div 
          className={`fixed inset-0 z-20 bg-black/50 transition-opacity duration-300 ease-[cubic-bezier(0.25,1,0.5,1)] ${isSidebarOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`} 
