...
const ChatTextArea = memo(forwardRef<ChatTextAreaHandle, ChatTextAreaProps>(({ 
    ...
    return (
        <Textarea 
            ref={textareaRef} 
            rows={1} 
            className="flex-grow p-2.5 bg-transparent text-gray-900 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none resize-none hide-scrollbar text-sm sm:text-base leading-relaxed max-h-[200px] border-none shadow-none focus-visible:ring-0" 
