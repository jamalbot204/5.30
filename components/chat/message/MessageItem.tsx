...
const MessageItemComponent: React.FC<MessageItemProps> = ({ message, canRegenerateFollowingAI, highlightTerm, onEnterReadMode, isContentExpanded, isThoughtsExpanded, onToggleExpansion, isLatestMemoryUpdate }) => {
  ...
  let bubbleClasses = '';
  if (isUser) {
      bubbleClasses = 'bg-teal-50/60 dark:bg-[#27272a] backdrop-blur-md dark:backdrop-blur-none border border-teal-600/10 dark:border-white/5 rounded-2xl px-5 py-4 text-zinc-900 dark:text-zinc-200 shadow-sm shadow-teal-900/5 dark:shadow-none';
  } else if (isError) {
      bubbleClasses = 'bg-red-50/80 dark:bg-red-900/30 backdrop-blur-md dark:backdrop-blur-none border border-red-200 dark:border-red-500/50 text-red-900 dark:text-red-100 shadow-sm shadow-red-900/5 dark:shadow-lg dark:shadow-red-900/20 rounded-2xl rounded-bl-sm';
  } else {
      bubbleClasses = 'bg-white/70 dark:bg-[#18181b] backdrop-blur-md dark:backdrop-blur-none border border-teal-600/15 dark:border-white/5 rounded-2xl px-5 py-4 text-zinc-900 dark:text-zinc-300 shadow-sm shadow-teal-900/5 dark:shadow-none';
  }
