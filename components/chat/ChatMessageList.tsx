        ...
        >
            ...
            <div className={`sticky top-0 w-full flex justify-end px-1 z-50 pointer-events-none transition-opacity duration-300 -mb-10 ${showScrollTop ? 'opacity-100' : 'opacity-0'}`}>
                <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="rounded-full bg-white/70 dark:bg-zinc-800 backdrop-blur-md text-gray-500 dark:text-gray-400 hover:text-teal-700 dark:hover:text-white hover:bg-white/90 dark:hover:bg-zinc-700 border border-teal-600/15 dark:border-white/10 shadow-md shadow-teal-900/5 dark:shadow-lg pointer-events-auto transform translate-y-1"
                    title="Scroll to Top"
                >
                        ...
                        {!isLoading && !isCharacterModeActive && showContinueFlowButton && visibleMessages.length > 0 && visibleMessages[visibleMessages.length - 1].role === 'model' && (
                            <div className="relative z-10 mt-2 mb-2 px-4 flex flex-col items-start gap-4 animate-fade-in">
                                ...
                                <Button 
                                    ...
                                    className="flex items-center gap-2 py-2.5 px-6 rounded-full border-emerald-600/20 dark:border-emerald-500/30 text-emerald-700 dark:text-emerald-400 bg-white/60 dark:bg-emerald-500/5 backdrop-blur-md hover:bg-white/90 dark:hover:bg-emerald-500/10 transition-all shadow-sm shadow-emerald-900/5 dark:shadow-md group border-2"
                                >
            ...
            <div className={`sticky bottom-4 w-full flex justify-end px-1 z-40 pointer-events-none transition-opacity duration-300 -mt-10 ${showScrollBottom ? 'opacity-100' : 'opacity-0'}`}>
                <Button
                    ...
                    variant="primary"
                    size="icon"
                    className="rounded-full shadow-md shadow-teal-900/20 dark:shadow-lg pointer-events-auto transform -translate-y-1"
